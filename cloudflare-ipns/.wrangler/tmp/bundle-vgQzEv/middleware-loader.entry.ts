...
import worker from "/media/root/data/publish_project/node-publiish/cloudflare-ipns/.wrangler/tmp/bundle-vgQzEv/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/media/root/data/publish_project/node-publiish/cloudflare-ipns/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/media/root/data/publish_project/node-publiish/cloudflare-ipns/.wrangler/tmp/bundle-vgQzEv/middleware-insertion-facade.js";
