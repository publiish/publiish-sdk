...
import PubliishApiHelper from "publiish-api-helper"
  ...
  function handleSubmitFile(e: any) {
    if (files.length === 0) {
      ...
      // write submit logic here
        ...
        const apiKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJicmFuZElkIjoxLCJpc0RlZmF1bHQiOiJmYWxzZSIsInN0b3JhZ2VTaXplIjoiMCIsImlhdCI6MTcxMjc3NjczOCwiZXhwIjoxNzIwNTUyNzM4fQ.yya2G705x5h7zTSjjUVcein56VKm9uhVJaKJGnG_hQ8";
        
        const publiishApiHelper = new PubliishApiHelper({publiishApiUrl: PUBLISH_API_URL!, apiKey: apiKey});
        publiishApiHelper.files.uploadFile( {
          content: files[0],
          auth_user_id: 1,
          uploadProgressCallback: handleUploadProgress
        } ).then((result)=>{
          toast.success(`File CID: ${result.data[0].cid}`);
